...
class NewsfrontnovorossiyaSpider(scrapy.Spider):
    name = 'newsfrontnovorossiya'
    base_url = 'https://en.news-front.info/category/novorossiya/'
    ...
    def parse(self, response):
        ...
        new_url = 'https://en.news-front.info/category/novorossiya/page/' + str(page_number)

        if page_number is not 50:
