...
class NewsfrontworldSpider(scrapy.Spider):
    name = 'newsfrontworld'
    base_url = 'https://en.news-front.info/category/world/'
    ...
    def parse(self, response):
        ...
        new_url = 'https://en.news-front.info/category/world/page/' + str(page_number)

        if page_number is not 810:
