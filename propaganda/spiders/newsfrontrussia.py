...
class NewsfrontrussiaSpider(scrapy.Spider):
    name = 'newsfrontrussia'
    base_url = 'https://en.news-front.info/category/russia/'
    ...
    def parse(self, response):
        ...
        new_url = 'https://en.news-front.info/category/russia/page/' + str(page_number)

        if page_number is not 234:
