...
class NewsfrontarticlesSpider(scrapy.Spider):
    name = 'newsfrontarticles'
    base_url = 'https://en.news-front.info/category/read-articles/'
    ...
    def parse(self, response):
        ...
        new_url = 'https://en.news-front.info/category/read-articles/page/' + str(page_number)

        if page_number is not 155:
